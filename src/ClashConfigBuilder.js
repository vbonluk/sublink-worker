...
export class ClashConfigBuilder extends BaseConfigBuilder {
    ...
    formatConfig() {
        ...
        this.config.rules.push(`DOMAIN-SUFFIX,google.com,${t('outboundNames.TestFairy Auto')}`);
        this.config.rules.push(`DOMAIN-SUFFIX,testfairy.com,${t('outboundNames.TestFairy Auto')}`);
